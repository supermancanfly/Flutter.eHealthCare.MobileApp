            ...
            child: GestureDetector(
              ...
              child: Obx(() {
                if (Get.find<SettingsService>().address.value?.isUnknown() ?? true) {
                  return Text("Please choose your address".tr, style: Get.textTheme.caption.merge(TextStyle(color: Colors.black, height: 0, fontWeight: FontWeight.bold , fontSize: 15)));
                }
