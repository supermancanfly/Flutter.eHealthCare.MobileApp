                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ClinicTilWidget(
                          ...
                          content: Ui.applyHtml(_clinic.description ?? '', style: Get.textTheme.bodyText1),
                        ),
                        buildAddress(context),
                        buildAwards(),
                        ClinicTilWidget(
                          horizontalPadding: 0,
                          title: Text("Featured Doctors".tr, style: Get.textTheme.subtitle2).paddingSymmetric(horizontal: 20),
                        ...
                        ClinicTilWidget(
                          ...
                          content: Column(
                            children: [
                              Text(_clinic.rate.toString(), style: Get.textTheme.headline1),
                              Wrap(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(controller.clinic.value.address.address, style: Get.textTheme.caption),
                          ],
                        ),
                      ),
                      MaterialButton(
